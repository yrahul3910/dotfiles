...
- Never use older Python syntax. Prefer 3.12+ generics over `TypeVar`; prefer `X | None` over `Option[X]`; avoid `from __future__ import annotations` unless you absolutely need it.
